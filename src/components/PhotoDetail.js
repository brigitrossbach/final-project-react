...
class PhotoDetail extends React.Component {
  ...
  return (
    <div>
    <iframe src="https://giphy.com/embed/3oEjI6SIIHBdRxXI40" title='giphy' width="480" height="480" frameBorder="0" className="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/mashable-3oEjI6SIIHBdRxXI40">via GIPHY</a></p>
    </div>
      )
    }
  }
